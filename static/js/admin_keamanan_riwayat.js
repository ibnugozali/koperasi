...
document.getElementById('securityForm').addEventListener('submit', function(e) {
    ...
    alert('Pengaturan keamanan riwayat berhasil disimpan!');
});
...
function resetSettings() {
    if (confirm('Apakah Anda yakin ingin mereset pengaturan ke default?')) {
        ...
        document.getElementById('accessControl').value = 'role_based';
        document.getElementById('auditLogRetention').value = '365';
        document.getElementById('backupFrequency').value = '7';
        document.getElementById('enableDataMasking').checked = true;
        document.getElementById('enableIntegrityCheck').checked = true;
        document.getElementById('enableAnomalyDetection').checked = false;
    }
}
