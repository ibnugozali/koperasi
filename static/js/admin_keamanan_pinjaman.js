...
document.getElementById('securityForm').addEventListener('submit', function(e) {
    ...
    alert('Pengaturan keamanan data pinjaman berhasil disimpan!');
});
...
function resetSettings() {
    if (confirm('Apakah Anda yakin ingin mereset pengaturan ke default?')) {
        ...
        document.getElementById('retentionPeriod').value = '7';
        document.getElementById('auditRetention').value = '24';
        document.getElementById('enableAutoValidation').checked = true;
        document.getElementById('enableRiskAssessment').checked = false;
        document.getElementById('enableComplianceCheck').checked = true;
    }
}
