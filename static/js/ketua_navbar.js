...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (currentURL.includes('/ketua/konfirmasi') || currentURL.includes('/ketua/anggota')) {
    ...
    if (currentURL.includes('/ketua/riwayat') || currentURL.includes('/ketua/laporan')) {
    ...
    if (currentURL.includes('/ketua/pengaturan')) {
