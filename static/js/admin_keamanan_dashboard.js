...
document.getElementById('securityForm').addEventListener('submit', function(e) {
    ...
    alert('Pengaturan keamanan dashboard berhasil disimpan!');
});
...
function resetSettings() {
    if (confirm('Apakah Anda yakin ingin mereset pengaturan ke default?')) {
        ...
        document.getElementById('enableActivityLog').checked = true;
        document.getElementById('enableAutoLogout').checked = true;
    }
}
